...
![Project Banner / Homepage Screenshot](image_placeholder_banner.png)
*Placeholder: Add a high-quality screenshot of the main application homepage with Dark/Light mode visible.*
